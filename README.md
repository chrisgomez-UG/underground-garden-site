...
- **Instagram feed embed** — live on the Gallery page ("Live From The Garden" section), a LightWidget embed (chosen over SnapWidget for being lighter-weight, matching how the rest of the site avoids heavy JS) connected to `@undergroundgardenevents`.
